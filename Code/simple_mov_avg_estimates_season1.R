...
file_path <- file.path('G:','infectious_disease_modelling_dataset','household_1_season_1.csv')
...
file_write_out = file.path('G:','infectious_disease_modelling_dataset','simp_mov_avg_estimates_season1.csv')
